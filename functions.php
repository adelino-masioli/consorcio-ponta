...
function set_qr(){
    $protect_url = array('sicoob-consorcios', 'institucional', 'fique-por-dentro', 'veiculos', 'imoveis', 'motos', 'veiculos-pesados', 'servicos', 'informacoes-sobre-o-grupo', 'contato', 'segunda-via-do-boleto', 'oferte-seu-lance', 'ouvidoria');
    return $protect_url;
}
